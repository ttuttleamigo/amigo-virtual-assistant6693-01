...
# General Amigo Troubleshooting Flow Specification

**NOTE: This is a specification document only - not for implementation**

## Conversation: General Amigo troubleshooting

This is for if a customer can't find their serial number or doesn't know what model they have.
...
User can choose:
- "My Amigo turns on, but the charger will not turn on or the batteries do not hold a charge" -> go to: Step_For_GenAmigo_battery_troubleshooting
...
Bot says:
- "Connect the AC cord to the wall outlet. Does the battery gauge on the throttle enclosure flash for 10-30 seconds before going solid?"
...
User can choose:
- "Yes" -> go to: measure_voltage_ac_side
- "If the wall outlet is still not working, our service team may be able to help with your Amigo troubleshooting." -> go to: contact_agent
...
Bot says:
- "Replace the Dc cable that connects the battery charger to the motor controller. Does the battery gauge flash now when the cord reel is connected to the wall outlet?"
...
Bot says:
- "Does the battery display or diagnostic code window on the throttle enclosure illuminate when the Amigo is turned on?"
...
Bot says:
- "When measuring the battery voltage in series, do they have a minimum combined voltage of 16 volts?"
...
Bot says:
- "Your batteries may not have enough charge in them to power the Amigo. Plug the AC cord in, fully charge the batteries, then see if the Amigo will run"
...
- Phone: 1-800-692-6446
- Email: support@amigomobility.com
- Hours: Monday-Friday, 8AM-5PM EST

### order_parts
- Call parts department: 1-800-692-6446
- Email: parts@amigomobility.com
- Website: amigomobility.com/parts
- Need model number and serial number

### end_conversation
- Troubleshooting complete
- Contact support if further assistance needed
