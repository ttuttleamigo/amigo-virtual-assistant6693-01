...
# Vista Troubleshooting Flow Specification
...
User can choose:
- "My Vista turns on, but the charger will not turn on or the batteries do not hold a charge" -> go to: Step_For_Vista_battery_troubleshooting
...
### order_parts
- Directs user to parts ordering process
- Standard parts flow

### end_conversation
- Conversation termination point
- Standard end flow
