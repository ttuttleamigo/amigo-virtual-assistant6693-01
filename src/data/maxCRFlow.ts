...
export const maxCRFlow: { [key: string]: ConversationStep } = {
  ...
  Order_parts: {
    botMessage: "You can order parts by calling our parts department at 1-800-692-6446 or visiting our website. Our team will help you get the right parts for your Max CR.",
    userOptions: [
      {
        text: "Thank you",
        nextStep: "end_conversation"
  ...
  contact_agent: {
    botMessage: "I'll connect you with our support team. You can reach them at 1-800-692-6446 or email support@amigomobility.com for personalized assistance.",
    userOptions: [
      {
        text: "Thank you",
        nextStep: "end_conversation"
  ...
  end_conversation: {
    botMessage: "Thank you for using Amigo Mobility's virtual assistant. If you need further assistance, don't hesitate to contact our support team!",
    userOptions: []
  }
};
