      ...
      {!hasOnlyButtonOptions && (
        <div className="p-4 border-t border-gray-200 flex-shrink-0 bg-slate-500">
          <div className="relative">
            ...
            <Button onClick={sendMessage} size="sm" className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-blue-600 hover:bg-blue-700 text-white border-0 h-8 w-8 p-0" disabled={!inputValue.trim() || isInputDisabled}>
